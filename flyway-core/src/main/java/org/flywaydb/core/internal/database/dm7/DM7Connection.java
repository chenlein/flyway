 ...
 * @Description:
 */
public class DM7Connection extends Connection<DM7Database> {

    protected DM7Connection(Configuration configuration, DM7Database database, java.sql.Connection connection, boolean originalAutoCommit) {
    ...
    public Schema getSchema(String name) {
        return new DM7Schema(jdbcTemplate, database, name);
    }
}
