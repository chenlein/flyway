 ...
 * @Description:
 */
public class DM7SqlStatementBuilder extends SqlStatementBuilder {
    ...
    public DM7SqlStatementBuilder(Configuration configuration) {
    ...
    public boolean canDiscard() {
        return super.canDiscard() || statementStart.equals("/ "); // Lone / that can safely be ignored
    }
